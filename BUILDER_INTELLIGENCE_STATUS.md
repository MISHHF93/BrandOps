...
**Status:** Core services implemented. Baseline is **982/982 tests across 152 files** passing (not 744/136 — those figures were stale even after the builder batch).
...
| 29 | Feature Registry | IMPLEMENTED + VERIFIED | featureRegistry.ts | 982/982 tests pass (current baseline) | Machine-readable feature registry; entries carry owning module, UI exposure, backend implementation, permissions, dependencies, maturity. |
...
- Tests: **982/982 passing (152 test files)** — the original "744/744 (136 files)" figure is superseded.
