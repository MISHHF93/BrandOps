...
| **Advanced — full model**        | `WorkspaceModelReadout`                   | Read-only table: timezone, theme, Cockpit, AI adapter, identity provider, notification center, deep work blocks, sync flags, overlay, automation summary, brand voice _preview_, etc. |
