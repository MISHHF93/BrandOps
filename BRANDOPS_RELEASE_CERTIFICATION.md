...
> certain file citations are stale. Current real baseline: **1122 tests / 217 files
...
| Test Coverage             | 9/10     | 1122 tests, 217 files, all passing. A→Z loop test present (`canonicalLoopEndToEnd`).                                                                                                                                       |
