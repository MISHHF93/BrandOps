...
> certain file citations are stale. Current real baseline: **1122 tests / 220 files
...
| Test Coverage             | 9/10     | 1122 tests, 220 files, all passing. A→Z loop test present (`canonicalLoopEndToEnd`).                                                                                                                                       |
