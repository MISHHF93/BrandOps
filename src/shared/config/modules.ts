 ...
 *
 * The live product uses a **two-tab dock** on `mobile.html` (`MobileApp`): **Assistant** (default cold load)
 * and **Plan** (workspace overview — instruments + queue + shortcuts into Today / Integrations / Settings).
