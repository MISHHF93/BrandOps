    ...
    >
      ...
      >
        ...
        <p className="text-xs text-textMuted">
          Take two minutes to shape the workspace around your real weekly rhythm before you start stuffing it with more
          tools.
        </p>
        <article className="rounded-xl border border-border bg-bg/45 p-3">
          ...
          <p className="mt-2 text-xs text-textMuted">
            BrandOps is a daily operator cockpit. It does not replace thinking; it organizes and amplifies it.
          </p>
          <p className="mt-2 text-xs text-textMuted">
            Visibility over automation · Structure over chaos · Execution over intention · Clarity over abstraction
          </p>
        </article>
        <ol className="list-decimal space-y-1 pl-5 text-xs text-textMuted">
          <li>Finish this checklist, then you will be prompted to set your operator profile (or skip).</li>
          <li>
            Use Pipeline and Brand & content for outreach, pipeline, library, publishing, and brand vault — they are
            areas here, not separate products.
          </li>
        ...
        <p className="text-xs text-textMuted">
          ...
          <span className="font-medium text-text">Settings → Integrations</span> — not on this screen, so you only
          connect OAuth once in the right place.
        </p>
