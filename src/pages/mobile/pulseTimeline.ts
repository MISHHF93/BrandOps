...
/**
 * Mixed chronological queue for the Pulse tab: open follow-ups, attention publishing,
 * active scheduler tasks, and draft/ready outreach — capped for mobile performance.
 */
