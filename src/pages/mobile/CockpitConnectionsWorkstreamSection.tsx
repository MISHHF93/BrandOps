...
export const CockpitConnectionsWorkstreamSection = ({
  ...
  >
    ...
    <ul className="mt-1 space-y-1 text-meta text-textSoft">
    ...
    {snapshot.integrationArtifactsPeek.length > 0 ? (
      <div className="mt-3 border-t border-border/25 pt-3">
        <p className="text-meta font-medium text-textSoft">Integration artifacts (top)</p>
        ...
        <ul className="mt-2 space-y-1.5 text-meta text-textSoft">
          {snapshot.sshTargetsPeek.map((row) => (
            <li key={row.id} className="flex justify-between gap-2">
              ...
              <span className="shrink-0 font-mono text-fine text-textMuted">{row.host}</span>
            </li>
          ))}
        </ul>
      </div>
    ...
    {snapshot.cockpitCompanyPeek.length > 0 ? (
      <div className="mt-3 border-t border-border/25 pt-3">
        <p className="text-meta font-medium text-textSoft">Companies (active)</p>
        <span className="sr-only">
