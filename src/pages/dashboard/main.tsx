...
import { shouldRedirectDashboardSectionToMobile } from './dashboardRedirect';
...
if (typeof window !== 'undefined') {
  if (shouldRedirectDashboardSectionToMobile(window.location.pathname, window.location.search)) {
