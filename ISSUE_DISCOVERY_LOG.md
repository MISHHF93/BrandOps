...
> **STATUS NOTE (2026-08-31):** This is a historical fix log. The final line's snapshot ("809 tests passing") reflects that earlier session's tree; the current baseline is **982/982 tests across 152 test files passing**. Issues #26–#30 were flagged "pre-existing" in that session — several have since been resolved as the tree moved to the 982-test baseline.
